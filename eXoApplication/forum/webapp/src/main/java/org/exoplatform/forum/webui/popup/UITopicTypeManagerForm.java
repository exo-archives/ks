...
@ComponentConfig(
		...
		events = {
			@EventConfig(listeners = UITopicTypeManagerForm.SaveActionListener.class),
...
public class UITopicTypeManagerForm extends BaseForumForm implements UIPopupComponent{
	...
	static	public class SaveActionListener extends BaseEventListener<UITopicTypeManagerForm> {
