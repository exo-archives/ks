...
TableSpliter.prototype.processeWithHeight = function() {
  ...
  if (TableSpliter.layoutContainer) {
    ...
    TableSpliter.init('UIWikiMiddleArea');
  }
};
...
TableSpliter.prototype.setHeightLayOut = function() {
  ...
  var delta = 0;
  while ((delta = TableSpliter.heightDelta()) > 0 && hdef >= 200) {
    hct = hdef - delta;
    hdef = hdef - 2;
...
TableSpliter.prototype.exeRowSplit = function(e) {
  ...
  if (TableSpliter.leftArea && TableSpliter.rightArea && TableSpliter.leftArea.style.display != "none"
      && TableSpliter.rightArea.style.display != "none") {
