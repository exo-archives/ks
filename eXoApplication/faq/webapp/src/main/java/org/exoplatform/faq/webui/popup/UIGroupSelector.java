 ...
 * SARL Author : Pham Tuan
 *               phamtuanchip@yahoo.de 
 * Aug 29, 2007 11:57:56 AM
 */
@ComponentConfigs(
		{
				@ComponentConfig(template = "app:/templates/faq/webui/popup/UIGroupSelector.gtmpl", 
						events = {
				...
				@ComponentConfig(type = UITree.class, id = "UITreeGroupSelector", 
...
public class UIGroupSelector extends UIGroupMembershipSelector implements UIPopupComponent, UISelectComponent {
	...
	static public class SelectMembershipActionListener extends EventListener<UIGroupSelector> {
		public void execute(Event<UIGroupSelector> event) throws Exception {
			...
			UIPopupAction uiPopup = uiPopupContainer.getAncestorOfType(UIPopupAction.class);
			uiPopup.deActivate();
