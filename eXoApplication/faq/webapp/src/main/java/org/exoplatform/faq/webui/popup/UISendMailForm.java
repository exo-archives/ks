...
@ComponentConfig(
		...
		events = {
				@EventConfig(listeners = UISendMailForm.SaveActionListener.class),
				@EventConfig(listeners = UISendMailForm.CancelActionListener.class)
		}
)
public class UISendMailForm extends UIForm	{
	 
	public UISendMailForm() throws Exception {
	}
	
	static public class SaveActionListener extends EventListener<UISendMailForm> {
