...
exo Knowledge Suite 1.2 features several noteworthy changes:
	...
	*Answers 
		 ...
		 o Screen name 
		 o Category Scoping 
		 o Plugin to load default Data in FAQ 
	*Forum
		 o Topic subscription UI management   
		 o Show tags on thread screen 
		 o Auto-prune management UI 
		 o Search in attachments 
		 o Allow permission management by Category 
		 o Remember UI layout 
		 o RSS Feeds 
		 o New tags management 
		 o Tags suggestions 
		 o Topics types 
		 o Screen name 
		 o Topic Poll Portlet 
		 o Custom BBCodes : Administration Tab 
		 o Custom BBCodes : Add/Edit BBCode dialog 
		 o Portlet preferences for enabled panels 
		 o Untag 
	*NEW FAQ portlet
=========
 INSTALL
